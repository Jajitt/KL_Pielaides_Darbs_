...
def registre():
    ...
    db.execute("INSERT INTO dalibnieki (vards, gramata_id) VALUES (?, ?)", (vards_obf, gramata_id))
    db.commit()
...
def paradit_dalibniekus():
    ...
    dalibnieki = []
    for r in rezultati:
        vards_desif = r["vards"][::-1]
        dalibnieki.append({"vards": vards_desif, "nosaukums": r["nosaukums"]})

    return render_template("dalibnieki.html", dalibnieki=dalibnieki)
